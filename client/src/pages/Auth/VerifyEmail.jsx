          ...
          >
            <FieldGroup>
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-customGreen select-none">
                  Verify Your Email
                </h1>
                <p className="text-customGray font-semibold text-base md:text-lg select-none max-w-md">
                  We've sent a verification email to:
                </p>
                <p className="text-customGreen font-bold text-lg">
                  {currentUser.email}
                </p>
                <p className="text-customGray text-sm select-none max-w-md">
              ...
              <FieldDescription className="text-center text-base select-none">
                <button
                  ...
                  className="text-customGray hover:text-customGreen flex items-center justify-center gap-2 mx-auto cursor-pointer"
                >

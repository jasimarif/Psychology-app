          ...
          >
            <FieldGroup className="gap-4">
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-3xl md:text-4xl font-bold text-teal-900">Reset Password</h1>
              ...
              <FieldDescription className="text-center text-base text-gray-500">
                Remember your password? <Link to="/login" className="text-teal-800 hover:underline font-medium">Back to login</Link>
              </FieldDescription>
            </FieldGroup>
          </form>
          <div

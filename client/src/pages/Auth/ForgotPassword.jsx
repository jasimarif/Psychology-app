          ...
          >
            <FieldGroup className="gap-4">
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-3xl md:text-4xl font-bold text-customGreen select-none">Reset Password</h1>
              ...
              <FieldDescription className="text-center text-base text-customGray select-none">
